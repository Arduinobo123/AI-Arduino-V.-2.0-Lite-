...
print("Hello from Arduino community. " + "arduino.cc")
...
def playlist():
    tkinter.messagebox.showinfo("Here is a playlist made by me. Hope you will enojoy. You can listen different types of music according to your moods.")
    webbrowser.open("https://music.youtube.com/playlist?list=PL8qJFT6AWCtLHzAbUax9HLxrhkWXpQGOa")
    sleep(5)
    tkinter.messagebox.showerror("Remember to pay respect the artist!")
    tkinter.messagebox.showwarning("All the music you will here is going to be present on youtube music!")
